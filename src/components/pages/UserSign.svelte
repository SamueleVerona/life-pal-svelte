...
<section class="section-sign flex flex-col flex-1 items-center justify-center relative overflow-hidden bg-theme-bg" >
  ...
  >
    ...
    on:keyup={loadCredentials}
    >
      <div class="px-4 mb-2 overflow-visible" >
        <span data-type="email" class="badge rounded-2xl text-2xl h-10 w-block tracking-wide font-semibold cursor-pointer select-none shadow-sm shadow-slate-200 hover:shadow-slate-300 hover:text-sky-500 font-normal hover:font-bold " >
          Email: john.smith@email.com
        </span>
        <span data-type="password" class=" badge rounded-2xl text-2xl h-10 w-block font-semibold tracking-wide cursor-pointer select-none shadow-sm shadow-slate-200 hover:shadow-slate-300 hover:text-sky-500 font-normal hover:font-bold">
          Password: password
        </span>
      </div>
      <div class="px-4 overflow-visible">
        <span data-type="email" class=" badge rounded-2xl text-2xl h-10 w-block  font-semibold tracking-wide cursor-pointer select-none shadow-sm shadow-slate-200 hover:shadow-slate-300 hover:text-sky-500 font-normal hover:font-bold">
